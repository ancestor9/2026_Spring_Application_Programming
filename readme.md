...
| 3  | 네트워크 & 웹 구조 이해 II    | requests 모듈, json 형태 데이 | url = "https://jsonplaceholder.typicode.com/users"<br> url = "https://jsonplaceholder.typicode.com/posts" | json -> pandas ->  'address' 변수를 pandas<br> json을 -> pandas |
