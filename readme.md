...
| 3  | 네트워크 & 웹 구조 이해 II    | requests 모듈, json 형태 데이 | 1. 네이버와 구글의 서버 헤더 정보 비교하기 <br>2. url = "https://jsonplaceholder.typicode.com/users"<br> 3. url = "https://jsonplaceholder.typicode.com/posts" | 2. json -> pandas ->  'address' 변수를 pandas<br> 3. json을 -> pandas |
